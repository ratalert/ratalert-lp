...
const commands = {
    ...
    newRewardPeriod: async(contract, amount, start, end) => {
        ...
        console.log(`Creating new reward period from ${startEpoch} (${startDate.toISOString()}) to ${endEpoch} (${endDate.toISOString()}) with a reward of ${toWei(amount)} (${amount}) FFOOD. Current block: ${currentBlock}.`);
        // return console.log(startEpoch, endEpoch);
